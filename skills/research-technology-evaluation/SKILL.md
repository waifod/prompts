---
name: research-technology-evaluation
description: Evaluating, comparing, choosing, or selecting a technology, library, framework, or tool. Covers scope definition, sources, evaluation template, and synthesis.
---

# Technology Evaluation

Process for researching and evaluating a technology, library, framework, or tool. Activate the `research-methodology` skill and follow it during the evaluation.
