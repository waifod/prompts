...
description: "Investigating, troubleshooting, or resolving ambiguous or complex problems. Four phases: research, narrative document, execution plan, and optional agent handoff."
---
...
This is not for fixing a known bug (activate the `research-bug-investigation` skill for that). This is for taking a messy, underspecified problem and turning it into something actionable.
...
Activate the `research-methodology` skill and follow it. The research question is: what is the actual problem, and what are the options for resolving it?

Do not generate solutions during research. Complete the research phase first.

## Phase 2: Narrative Document

Write a document explaining the problem for the user. Activate the `document-writing` skill and follow it for structure and drafting discipline.
