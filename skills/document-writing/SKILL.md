...
description: Writing, drafting, reviewing, editing, or checking documents such as design docs, proposals, runbooks, guides, and postmortems. Covers research, outlining, and review.
---
...
Activate the `research-methodology` skill and follow it. Gather information from the starting pointers the user provides, then expand outward to related sources. Record findings before moving on. Do not start drafting until the research phase is complete and findings are synthesized.
