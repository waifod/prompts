---
name: coding
description: Coding workflow rules. Covers complexity assessment, plan/execute/verify cycle, quality standards, testing, error messages, and file management.
---
...
- Complex (many files, unclear approach, unfamiliar codebase, architectural implications): activate the `problem-resolution` skill and follow the full research/plan/implement workflow. Write artifacts at each phase. Do not skip research.
