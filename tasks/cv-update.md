...
Rules for researching, updating, and maintaining a CV. For the research process itself (progress tracking, source-by-source gathering, write-as-you-go discipline), follow `research/methodology.md`. This file covers only what is specific to CV tasks.
...
Follow `research/methodology.md`. Sources typically include personal website, GitHub repos, LinkedIn, and similar. Record findings in the data file under the relevant section (in addition to the per-source notes in the research folder).
